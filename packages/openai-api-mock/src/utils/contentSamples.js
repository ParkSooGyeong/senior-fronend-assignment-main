 ...
 */
export const getContentSample = (userMessage) => {
...
**Bold text** and *italic text*`;
  ...
  if (message.includes('html')) {
    return `<div style="padding: 20px; background-color: #f5f5f5; border-radius: 8px;">
  <h2 style="color: #333;">HTML Example</h2>
  <p>This is a <strong>safe</strong> HTML example with:</p>
  <ul>
    <li>Lists</li>
    <li>Formatting</li>
    <li>Basic styling</li>
